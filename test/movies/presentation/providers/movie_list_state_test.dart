...
import 'package:remote_content_explorer/movies/presentation/providers/movie_list_state.dart';

void main() {
  group('MovieListState.showInitialLoader', () {
    test(
      'given isLoading is true and movies list is empty '
    ...
    test(
      'given isLoading is true but movies are already loaded '
      'when showInitialLoader is checked '
      'then returns false',
      () {
  ...
  group('MovieListState.showInitialError', () {
    test(
      'given hasError is true and movies list is empty '
    ...
    test(
      'given hasError is true but movies are already loaded '
      'when showInitialError is checked '
      'then returns false',
      () {
